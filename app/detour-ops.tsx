...
function CodeAssistant() {
  ...
  const [sourceAuthority, setSourceAuthority] = useState("Roads General Authority — Saudi Arabia");
  const [sourceEdition, setSourceEdition] = useState("Uploaded reference — revision to be verified");
